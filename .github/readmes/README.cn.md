...
这个资源库是为了让我学习 react fiber 而建立的，来自拉勾教育的课程，它能帮助我很好的理解浏览器 idle 和 fiber 的工作原理。

强烈建议你先去看看 [TinyReact](https://github.com/zqcccc/TinyReact) 这个仓库
...
这个仓库有两个入口，一个是客户端入口 `src/index.js`，另一个是服务端入口 `server.js`，希望能帮助到你学习 fiber
